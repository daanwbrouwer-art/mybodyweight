  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 30px 0 rgba(104, 211, 217, 0.3)",
        joker: "0 0 40px 0 rgba(104, 211, 217, 0.5)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "card-shuffle": "card-shuffle 0.8s cubic-bezier(0.4, 0, 0.2, 1)",
        "fade-in": "fade-in 0.4s ease-out",
        "slide-up": "slide-up 0.5s cubic-bezier(0.4, 0, 0.2, 1)",
        "joker-reveal": "joker-reveal 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)",
      },
    },
  },
